...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  try {
    ...
    // Fetch existing user data to merge with form data
    Map<String, dynamic> existingUserData = userProvider.userData ?? {};

    // Prepare data for API, prioritizing form inputs but falling back to existing data
    ...
    if (response.statusCode == 200 || response.statusCode == 201) {
      ...
      if (userProvider.userData != null) {
        ...
        updatedUserData['user_id'] = responseData['user_id'];
      }
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(userProvider.userData != null ? 'Profile updated successfully!' : 'Profile created successfully!')),
      );
    } else {
