...
class ServiceCard extends StatelessWidget {
  ...
  Future<List<ServiceReview>> _fetchReviews() async {
    try {
      ...
      final response = await http.get(Uri.parse('$apiUrl/servicereview/service/${service.serviceId}'));
  ...
  String _calculateAverageRating(List<ServiceReview> reviews) {
    ...
    // If average is a whole number, show as integer; otherwise, show one decimal place
    ...
    return Card(
      ...
      child: IntrinsicHeight(
        child: Row(
          ...
          children: [
            // Left: Image with Rating Overlay
            Stack(
              children: [
                ClipRRect(
                ...
                // Rating and View All - positioned at bottom
                Positioned(
                  bottom: 8,
                  left: 8,
                  right: 8,
                  child: FutureBuilder<List<ServiceReview>>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      // Don't show rating overlay if no reviews
